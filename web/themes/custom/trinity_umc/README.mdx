...
trinity_umc theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of trinity_umc theme and run the following commands:
`nvm use`
...
`drush en trinity_umc -y`
`drush config-set system.theme default trinity_umc -y`
